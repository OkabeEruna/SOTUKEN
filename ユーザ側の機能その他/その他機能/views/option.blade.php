...
<div class="hospital">
  <p>＊お気に入りの病院</p>
    <input type="text" value="○○病院">
</div>
<br>
<br>
<div class="messege">
    <p>＊通知機能</p>
    <input type="radio" name="radio" checked>ON<input type="radio" name="radio">OFF
</div>
<br>
<br>
<div class="help">
...
<form action="{{url('/home')}}" method="get"  class="form1"> 
            @csrf
  <input type="submit" name="submit" value="ホームに戻る" class="custom-btn btn-1_1"/>
</form>
<!--<form  name="signup" action="{{action('App\Http\Controllers\option_ConpController@move')}}" method="post"  class="form1"> 
        @csrf
      <input type="submit" id="regist" name="submit" class="custom-btn btn-4_1" value="登録する" />
</form>-->
