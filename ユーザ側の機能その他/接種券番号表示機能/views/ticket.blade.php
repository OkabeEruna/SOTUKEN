...
if($yoyaku == 0){
?>
<p style="font-size:25px">来院時は以下の接種券番号<!--QRコード-->を受付にてご提示ください。</p>
<br>
<p style="font-size:25px">○○さんの接種券番号</p>
<br>
<p style="font-size:40px">1234567890</p>
...
<br>
<br>
<p style="font-size:25px">接種券番号は予約完了後に表示されます。</p>
<?php
}
?>
<br>
