...
<br>
<br>
<!--<div class="clskweckbft">
    <div class="tbl">
        <table>
            <tr>
                <th style="width:15%">受信日</th>
                <th style="width:20%">題名</th>
                <th style="width:5%"></th>
            </tr>
            <tr>
                <td>2021/11/25</td>
                <td><a href="https://www.hi-joho.ac.jp/">こんにちは</a></td>
                <td><input type="submit" value="削除" onclick="deleteRow(this)"></td>
            </tr>
        </table>
    </div>
</div>-->
<div class="info">
<dl><dt>2020/01/01</dt><dd><a href="https://www.hi-joho.ac.jp/">※指定予約の方※問診票記入のお願い</a></dd></dl>
<dl><dt>2020/01/02</dt><dd>新着情報の内容が入ります。新着情報の内容が入ります。</dd></dl>
<dl><dt>2020/01/01</dt><dd>お知らせの内容が入ります。お知らせの内容が入ります。</dd></dl>
<dl><dt>2020/01/02</dt><dd>新着情報の内容が入ります。新着情報の内容が入ります。</dd></dl>
<dl><dt>2020/01/01</dt><dd>お知らせの内容が入ります。お知らせの内容が入ります。</dd></dl>
<dl><dt>2020/01/02</dt><dd>新着情報の内容が入ります。新着情報の内容が入ります。</dd></dl>
</div>
...
<form action="{{url('/home')}}" method="get"  class="form"> 
            @csrf
  <input type="submit" name="submit" value="ホームに戻る" class="custom-btn btn-1"/>
</form>
